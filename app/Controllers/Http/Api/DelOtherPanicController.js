...
class DelOtherPanicController extends RestController
{
    constructor()
    {
        super('DelOtherPanic'); //this is your model name
        this.resource = "DelOtherPanic"; //this is your resource name
...
module.exports = DelOtherPanicController
